...
\section{总结与展望}
在本系统中，我们开发了一个半自动的故事线生成工作。其相比于全自动方法StoryFlow更加快速，相比于半自动方法iStoryline更加灵活。本系统可以很好的连接电脑的快速计算与人的美观设计。我们还设计了一个重要的计算机辅助交互：变形。在你对故事线进行变形之后可以通过贪心算法尽力找到一系列其他交互，使得这两种操作等价，从而让你的故事线更加平整。我们也通过定性的用户实验和一组用例来证明了此系统的可用性。
